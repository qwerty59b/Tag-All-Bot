...
async def everyone(client, message):
  global stopProcess
  replied_msg_id = message.reply_to_message_id if message.reply_to_message_id is not None else None
  try: 
    try:
            ...
            try:
              ...
              while j < mbuff:
                ...
                if user.username == None:
                  ...
                  j+=1
              try:     
                await teletips.send_message(message.chat.id, text1, reply_to_message_id=replied_msg_id)
              except Exception:
                pass  
...
- /tag "input": <i>Mention all members.</i>
